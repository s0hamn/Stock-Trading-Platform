...
import MainImage from '../media/main-page-main-image.png';
...
function MainPage() {
    return (
        <>
            ...
            {/* Big space for photo */}
            <img src={MainImage} className='h-96 w-100 flex items-center justify-center m-auto mt-2 mb-24' />
            ...
            <div className="text-center mt-16 gap-9 mb-16">
                <p className="text-3xl font-sans p-3">Investing is the art of making money work for you.</p>
                <p className="text-3xl font-sans p-3">The stock market is a device for transferring money from the impatient to the patient.</p>
            </div>
